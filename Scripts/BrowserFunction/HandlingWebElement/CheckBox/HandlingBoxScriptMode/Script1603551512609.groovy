...
WebUI.delay(3);
if (WebUI.verifyElementNotChecked(findTestObject('AbodeqaWebUIElementObject/CheckBox/ManualCheckBox'), 2)) {
	WebUI.check(findTestObject('AbodeqaWebUIElementObject/CheckBox/ManualCheckBox'));
}
if (WebUI.verifyElementChecked(findTestObject('AbodeqaWebUIElementObject/CheckBox/ManualCheckBox'), 2)) {
